...
def kfold_svr(df, num_folds, output_name):
...
def main(file_name='default.csv'):
    ...
    with timer("Run train with full data 1"):
      ...
      print(df.shape)
      sub_df_1, val_label_1, val_train_1 = kfold_svr(df, num_folds= 5, output_name='Next_Premium_1')
    ...
    with timer("Run train with full data 2"):
      ...
      df = df[~mask]
      print(df.shape)
      sub_df_2, _, val_train_2 = kfold_svr(df, num_folds= 5, output_name='Next_Premium_2')
    ...
    with timer("Run train with full data 3"):
      ...
      df = df[~mask]
      print(df.shape)
      sub_df_3, _, val_train_3 = kfold_svr(df, num_folds= 5, output_name='Next_Premium_3')
    ...
    with timer("blend out put"):
      ...
      sub_df[['Policy_Number', 'Next_Premium']].to_csv('sub_file_svm_blend.csv', index= False)
